...
// Unlike the other surfaces this one cannot be applied to the request: the placeholder appears in frames sent
// after the upgrade, so it is carried to the frame pipe instead.
