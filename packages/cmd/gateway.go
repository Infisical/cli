...
func init() {
	...
	gatewayStartCmd.Flags().String("relay", "", "name of the relay to connect to") // Deprecated, use --target-relay-name instead
	...
	gatewaySystemdInstallCmd.Flags().String("relay", "", "The name of the relay") // Deprecated, use --target-relay-name instead
