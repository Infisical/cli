...
func ParseSessionFilename(filename string) (*SessionFileInfo, error) {
	...
	resourceTypePattern := fmt.Sprintf("(%s|%s|%s|%s|%s|%s|%s)", ResourceTypeSSH, ResourceTypePostgres, ResourceTypeRedis, ResourceTypeMysql, ResourceTypeMssql, ResourceTypeMongoDB, ResourceTypeKubernetes)
