...
func TestReplacesClientCredentialsWithTheAccountsOwn(t *testing.T) {
	...
	req.Header.Set("X-ClickHouse-Quota", "someone-elses-quota")
	...
	require.Empty(t, captured.headers.Get("X-ClickHouse-Quota"))
	require.Empty(t, captured.query.Get("quota_key"))
